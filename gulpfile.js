...
gulp.task('watch', function () {
	...
	// gulp.watch('app/img/*', ['copyImg']).on('change', browserSync.reload);
	gulp.watch('app/img/*', ['cleanImg']).on('change', browserSync.reload);
	gulp.watch('app/img/*', ['compressImg']).on('change', browserSync.reload);
